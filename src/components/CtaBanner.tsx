      ...
      <div className={wrap}>
        <Reveal>
          <div className="relative overflow-hidden rounded-3xl bg-[#424D76] px-8 lg:px-14 py-12 lg:py-16 grid lg:grid-cols-2 gap-8 items-center">
            ...
            <h2 className="relative font-serif text-[clamp(24px,2.5vw,36px)] font-bold text-white leading-tight whitespace-nowrap">
            ...
            <div className="relative">
              <p className="text-white/70 text-[20px] mb-4 max-w-[460px] whitespace-nowrap">
                Partner with us for smart, scalable and inclusive hiring solutions
              </p>
              <Link
                href="tel:+919415088702"
                className="inline-flex items-center justify-center gap-2 w-full max-w-[460px] bg-gradient-to-r from-accent via-accent-mid to-accent-gold text-white font-semibold text-[16px] px-7 py-2.5 rounded-xl shadow-[0_10px_25px_rgba(254,98,42,0.3)] hover:-translate-y-0.5 hover:shadow-lg transition-all"
              >
